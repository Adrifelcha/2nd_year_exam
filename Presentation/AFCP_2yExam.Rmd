...
We discuss the distinctions between experimental and differential psychology, with an emphasis on how the different ways in which they treat between-subject variability leads to a *reliability paradox*.
...
- **Q:** How does performance change between *groups*? 
...
- **Q:** How does performance change between *individuals*? 
...
- Shifting between mental sets or tasks. (*Shifting*).

- Controlling inputs and responses considered when solving a task. (*Cognitive control*).

- Monitoring and updating the contents of working memory. (*Updating*)
...
- Response-distracter inhibition
...
- Cognitive models account for the psychological processes that underlie the data observed.

--

<br>

- Psychometric models (LVMs) assumes that the data observed can be explained as the linear combination of latent variables that vary across different levels (i.e., across participants, conditions, tasks, etc.; Baribault, 2019). 

--

<br>

- LVMs do not assume that every latent variable has a relevant psychological interpretation (Bollen, 2002).
...
- Cognitive psychometrics refers to the psychometric treatment of cognitive models (Batchelder, 1998; Batchelder, 2010). 

--

- The goal is to identify whether the cognitive processes described by cognitive models vary across participants, items, conditions, tasks, and so on. 

--

- Cognitive psychometrics reconciliates the differences between experimental and differential research (Cronbach, 1957; Borsboom, 2006). 
...
- Schmiedek et al. (2007) fit an exGaussian model to the RT data and parameters of the DDM were estimated using both RTs and choice data. Then, the authors performed CFA techniques on all parameter values obtained. 

- Studies on the latent variable structure of cognitive control from the perspective of cognitive psychometrics (Miyake et al., 2000; Friedman and Miyake, 2004).

---

## Cognitive latent variable models

- Vandekerckhove (2014) introduced a class of models that explore the latent variable structure of the parameters of cognitive models, all as part of a hierarchical Bayesian model. 

- This feature comes with the huge advantage that the uncertainty contained in the data is captured and allocated across both model components (Vandekerckhove, 2014; Baribault, 2019). 
