...
##############################################################
# Figure 3A: TDDM with Color wheel
# ##############################################################
...
text(boundary-0.75,-4.2, "Pink", f=f, cex=cex.text)
...
text(boundary,-3.75, "Viewer", f=f, cex=cex.text)
text(-2.5,-3.75, "Ada", f=f, cex=cex.text)
